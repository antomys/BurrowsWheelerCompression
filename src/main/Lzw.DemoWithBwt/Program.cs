...
public sealed partial class PbvCompressor
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        // if valid arguments given proceed
        if (validCommands.IsMatch(args[0]))
        {
    ...
    [GeneratedRegex("-[cdCDbwtcBWTCbwtdBWTDhcHChdHDbcBClzbwclzbwd]")]
